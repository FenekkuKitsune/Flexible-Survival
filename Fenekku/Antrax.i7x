	...
	if resolution of Airborne Shadow is 0:
		...
		if Player consents:
			...
			if player is female:
				...
				WaitLineBreak;
				say "     You can only moan and spasm as you cum alongside the creature, the feeling of it filling you, bloating your womb with its seed, sending you over the edge. As much as your abused pussy tries to grip the creature's cock, it isn't amicable to staying with you. As the spasms in its shaft fade, you feel it pull back, sliding out of you unceremoniously. It growls once as it removes its claw from your back, finally freeing you. The exertion, however, has you remaining on your stomach for the moment, even as you feel the air rush over you, the creature's wings flapping to take it to the air once more. Flying away from you.";
			else: [ANAL]
				say "     ";
